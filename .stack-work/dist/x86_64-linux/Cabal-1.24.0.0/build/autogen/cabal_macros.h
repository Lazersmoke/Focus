...
/* package Focus-0.1.0.0 */
#define VERSION_Focus "0.1.0.0"
#define MIN_VERSION_Focus(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "Focus-0.1.0.0-BqLk9ULyuYJ2wT8bvEsHJr"

#define CURRENT_PACKAGE_KEY "Focus-0.1.0.0-BqLk9ULyuYJ2wT8bvEsHJr"
